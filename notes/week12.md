...
## WEB700 Week 12 Notes (<mark>TODO: Fix Formatting & move images using WEB322 as a Guide</mark>)
...
![https lock](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2016/08/https-lock.png)  
...
![https certificate details](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2016/08/https-certificate-details.png)  
...
From this pane there is also a View Certificate button. ![https view certificate](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2016/08/https-view-certificate.png)  
...
![https certificate viewer](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2016/08/https-certificate-viewer.png)  
...
Lastly, be sure to **copy your self signed certificate key and crt files into the week12\_assets folder** so that our week10.js server can find them.

Let's start it up (using the command: "node week10.js") and point our browser at **https**://localhost:8080
...
![https self signed certificate firefox](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2016/08/https-self-signed-cert.png) ![https self signed certificate advanced](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2016/08/https-self-signed-cert-advanced.png)

  

_Warning in Chrome_

![https self signed certificate chrome](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2016/08/https-self-signed-cert-chrome.png)
...
![](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2017/07/ff-cert-error.png)

_Warning in Chrome_

![](http://zenit.senecac.on.ca/~patrick.crawford/wp-content/uploads/2017/07/chrome-cert-error.png)
...
*   Test 6 Next Week
*   Assignment 6 Due this Friday at 11:59pm
